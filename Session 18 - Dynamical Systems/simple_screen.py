...
class SimpleScreen:
    def __init__(
        ...
        self.zoom_pos_start = (0.0, 0.0)
        self.zoom_pos_stop = (0.0, 0.0)        
        self.zoom_rect_color = Color(zoom_rect_color)

    def calc_world_rect(self):
        self.wx1 = self.world_rects[-1][0][0]
        self.wy1 = self.world_rects[-1][0][1]
        self.wx2 = self.world_rects[-1][1][0]
        self.wy2 = self.world_rects[-1][1][1]

        self.world_min = (self.wx1, self.wy1)
        self.world_max = (self.wx2, self.wy2)
    ...
    def update(self):
        ...
        if self.draw_function is not Ellipsis:
    ...
    def show(self):
        ...
        while running:
            for event in pygame.event.get():
                ...
                if self.event_function is not Ellipsis:
